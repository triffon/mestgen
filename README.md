Test generator intended to generate multiple test variants from single test source. Works with closed tests (where one of possible answers should be chosen). Written in Perl, works with TeX.
