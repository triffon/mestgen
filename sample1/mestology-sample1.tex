...
\usepackage[left=2cm,top=2cm,right=2cm,bottom=1.5cm,nohead,nofoot]{geometry}
...
\openQuestion[6cm]{Напишете ода за местологията в тристъпен ямб (не повече от 6 строфи).}
\question{
	две ментета?
}{
	\wrong не
...
\openQuestion{Какво бихте подобрили в mest? (1 изречение)}
\question{
	менте?
}{
	\wrong не
